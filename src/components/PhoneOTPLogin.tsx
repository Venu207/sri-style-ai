  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4 flex justify-center">
        ...
        >
          <div className="gradient-dark rounded-2xl p-8 md:p-10 shadow-xl border border-gold/20 relative overflow-hidden">
            {/* Decorative shimmer */}
              ...
              {step === "success" && (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-cream/60 text-sm font-body">
                      You're signed in. Explore our exclusive fashion collection.
                    </p>
                  </div>
                  <Link
                    to="/shop"
                    className="btn-gold rounded-lg inline-flex items-center gap-2"
                  >
